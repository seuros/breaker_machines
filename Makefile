RB_SYS_BUILD_DIR ?= /Users/seuros/Projects/ecosystem/breaker_machines/.rb-sys
CARGO ?= cargo
CARGO_BUILD_TARGET ?= 
SOEXT ?= dylib
...
RB_SYS_CARGO_MANIFEST_DIR ?= ext/breaker_machines_native/ffi
...
target_prefix = /breaker_machines_native
TARGET_NAME = breaker_machines_native
TARGET_ENTRY = Init_$(TARGET_NAME)
RUBYARCHDIR = $(sitearchdir)$(target_prefix)
TARGET = breaker_machines_native
DLLIB = $(TARGET).bundle
...
srcdir = ext/breaker_machines_native/ffi
...
export RBCONFIG_srcdir := ext/breaker_machines_native
